...
const heroImages = [heroImg2, heroImg1, heroImg3];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row gap-4 pt-10 w-full md:w-auto"
            >
              <Link href="/book">
              ...
              <a href="#contact">
                <Button variant="outline" size="lg" className="rounded-full px-8 py-6 text-lg border-primary/20 hover:bg-[hsl(var(--accent-pink))] hover:text-primary hover:border-[hsl(var(--accent-pink))] transition-all w-full sm:w-auto" data-testid="button-contact">
                  Contact Me
                </Button>
              </a>
            </motion.div>
          ...
          <motion.div
            ...
            className="relative h-[500px] md:h-[650px] w-full max-w-[400px] mx-auto md:ml-auto rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-[hsl(var(--accent-pink))] z-10"
          >
